        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div style="margin-bottom: 20px;">
              <a href="edit-ftw.php?StaffICPassport=<?php echo $_GET['StaffICPassport']?>" class="btn btn-success">Done</a>
            </div>
            <?php } ?>
            ...
            <div class="tile-body">
              <form class="row" method="post" enctype="multipart/form-data">
                ...
                <label class="control-label">Place of Examination</label>
                        <select name="placeExam" id="placeExam" class="form-control" onChange="getdistrict(this.value);">
